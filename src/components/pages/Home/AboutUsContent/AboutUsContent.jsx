  ...
  return (
    <div className="about-us-content-section p-4 my-3 bg-white rounded shadow-sm">
      <div className="mission-section mb-5">
        ...
        <ul>
          <li>
            Sứ mệnh của BẾP SẠCH VIỆT là trở thành nhịp cầu kết nối văn hóa ẩm
            thực giữa các vùng miền và người tiêu dùng. Thương hiệu không chỉ
          ...
          <li>
            Với BẾP SẠCH VIỆT, mỗi bữa ăn không chỉ là thời gian thưởng thức món
            ngon mà còn là cơ hội để gắn kết gia đình, chia sẻ yêu thương và
            trân trọng những giá trị truyền thống. Trong tương lai, BẾP SẠCH
            VIỆT sẽ không ngừng nỗ lực để tiếp tục sứ mệnh này, mở rộng thêm các
            dòng sản phẩm đặc sản vùng miền, mang đến sự lựa chọn phong phú và
